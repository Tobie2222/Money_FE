...
export default function SelectLanguageScreen() {
    ...
    return (
        <View className="flex-1 relative ">
            ...
            <View style={styles.inputSelect} className="w-[250px] mx-auto h-[40px] bg-white border border-borderColor mt-[75px] rounded-[8px]">
                <TextInput
            ...
            <View style={styles.inputSelect}  className="mt-[10px] mx-auto w-[250px] h-[140px] bg-white rounded-[8px] border border-borderColor">
                <ScrollView  className=" rounded-[8px] ">
                    {
                        items.map((item,index)=>{
                            return (
                                <TouchableOpacity onPress={()=>setSelectedValue(item.value)} key={index}  className="flex-row py-[10px] px-[16px] bg-white items-center gap-[10px]">
                                    <Image
